  ...
  return (
    <section className="resumesection mt-4" id="resumepage">
      <div className="animationresumespecificsection" data-aos="fade-up">
        ...
        <h1 className="text-white resumesectionh1 text-center mt-4 fw-bold" style={{ fontSize: '48px' }}>
          Professional Experience
        </h1>
        <p className="resumesectionp mt-3 fw-lighter" style={{ fontSize: '18px', color: '#ffffff99' }}>
        ...
        <div className="resumesectionresume d-flex rounded-4 overflow-hidden border border-dark" style={{ width: '1152px', height: '240vh' }}>
              ...
              <div className="skillssection">
                {[
                  ...
                  <div className="skill-container" key={idx}>
                    ...
                    <div className="skillprogressbar mt-2 w-100 bg-dark rounded-2 overflow-hidden" style={{ height: '8px' }}>
                      <div
            ...
            <div className="linkinfo mt-4">
              ...
              <div className="softskills">
                <div className="firstsoftskill mt-2 d-flex flex-wrap gap-2">
                  <span className="fw-lighter rounded-5 border border-secondary py-1 px-3" style={{ fontSize: '12px', backgroundColor: '#323232', color: '#ffffff99' }}>
                    Problem Solving
                  </span>
                  <span className="fw-lighter rounded-5 border border-secondary py-1 px-3" style={{ fontSize: '12px', backgroundColor: '#323232', color: '#ffffff99' }}>
                    Team Collaboration
          ...
          <div className="secondcolumn shadow-lg border-start border-dark p-3 py-4 px-4 ps-4 pt-4" style={{ width: '65%', backgroundColor: '#0D0D0D' }}>
            ...
            <div data-aos="fade-up" className="intro">
              ...
              <h5 style={{ color: '#ffffff99', width: '100%' }} className="introp pe-1 fs-6 text-left lh-base ms-0 me-0 w-100">
              ...
              <div data-aos="fade-right" data-aos-offset="100" data-aos-easing="ease-in-sine" className="flex justify-center items-center">
                ...
                <div className="company mt-1">
                  <div className="d-flex align-items-center" style={{ paddingLeft: '36px' }}>
                    <h4 className="fw-bolder mb-0" style={{ fontSize: '14px', color: '#ffffff99' }}>
                      Digitalaz Solution
                    </h4>
                    <ul className="mb-0 d-flex align-items-center gap-4" style={{ listStyleType: 'square', paddingLeft: '8px', margin: 0, marginLeft: '4px' }}>
                  ...
                  <div className="companypara mt-2" style={{ marginLeft: '13px' }}>
                    <ul className="companyul">
                      <li className="companyli fs-6 mb-2" style={{ color: '#ffffff99' }}>
            ...
            <div className="experience102">
              ...
              <div data-aos="fade-right" data-aos-offset="100" data-aos-easing="ease-in-sine" className="flex justify-center items-center">
                <div className="d-flex align-items-center mt-4">
                  <Circle width={12} height={12} stroke="gray" fill="#3D3D3D" strokeWidth={3} />
                  <span className="text-white fs-5 fw-bold ms-4">Govt Degree Boys College Johar Karachi, ICS | 2025 – Present</span>
                </div>
                <div className="company mt-1">
                  <div className="d-flex align-items-center" style={{ paddingLeft: '36px' }}>
                    <h4 className="fw-bolder mb-0" style={{ fontSize: '14px', color: '#ffffff99' }}>
              ...
              <div data-aos="fade-right" data-aos-offset="100" data-aos-easing="ease-in-sine" className="flex justify-center items-center">
                <div className="d-flex align-items-center mt-4">
                  <Circle width={12} height={12} stroke="gray" fill="#3D3D3D" strokeWidth={3} />
                  <span className="text-white fs-5 fw-bold ms-4">HPGS School Karachi, Computer Science | 2025</span>
                </div>
                <div className="company mt-1">
                  <div className="d-flex align-items-center" style={{ paddingLeft: '36px' }}>
                    <h4 className="fw-bolder mb-0" style={{ fontSize: '14px', color: '#ffffff99' }}>
      ...
      <div data-aos="fade-up" className="resumesectionlastdiv">
        <p className="fs-6 resumesectionlastptag" style={{ color: '#ffffff99' }}>
          Interested in working together?
        </p>
        <a href="#contactpage">
          <div className="d-flex justify-content-center mt-4">
            <button className="resumesectionlettalktobutton bg-white rounded-pill text-center p-3 fs-6">
              Let's Talk
              <span>
